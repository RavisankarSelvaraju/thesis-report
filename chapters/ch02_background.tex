...
\begin{document}
    ...
    If we need to transform a twist of the body frame represented in the body frame $\boldsymbol{\xi}_{body}^{body}$ to the twist of body frame represented in the world frame $\boldsymbol{\xi}_{body}^{world}$, we can use the following equation \ref{TwistTransformationEquation}. 
