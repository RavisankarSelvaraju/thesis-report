...
\begin{document}
    ...
    \section{Odometry} \label{subsec:backgroundOdometry}
        \fromproposal{
    ...
    \section{Slippage} \label{subsec:backgroundSlippage}
    ...
    \section{InEKF library and its update modalities}
    ...
    \section{invariance property of \gls{inekf}}
    ...
    \section{Twists} \label{subsec:twists}
    ...
    Since, the proposed approach, we plan to use the KDL library to transformation of Twists, we will follow the spatial velocity \ref{eq:RBDTwistRepresentation} convention by ordering the linear velocity first and then the angular velocity in the Twist vector. 
    
    \subsubsection*{Transforming Twists} \label{subsec:transformingTwists}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.95\textwidth]{media/plots/rpe_explanation_plot_1.png}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.95\textwidth]{media/plots/rpe_explanation_plot_2.png}
        \caption{Relative Pose Error (RPE) explanation plot}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.95\textwidth]{media/plots/APE_explanation_plot_1.png}
    ...
    \section{Left and Right Invariant Error} \label{sec:LeftAndRightInvariantError}
    \section{Invariance in InEKF} \label{sec:InvarianceInInEKF}
